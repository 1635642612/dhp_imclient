...
var righticon = document.querySelector(".icon-qunzutianchong");
//查看个人信息
var more = document.querySelector(".mui-icon-more");

function toprofile(){
	//查询用户信息
	mui.post(sip+"getUser.do",{id:tid},function(data){
...
function initpage(){
	...
	//类型是1代表单聊 ；显示加载更多
	if(ttype=="1"){
		more.classList.remove("mui-hidden");
	}
